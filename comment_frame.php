...
<html>
  ...
  <body>
    ...
    <!-- creating a function toggle that hides the comment if visible already, and displays it if it was not visible -->
    <script>
      function toggle() {
    ...
    // adding the comment to the comments table
     ...
     if($count != 0) {
       while($comment = mysqli_fetch_array($get_comments)) {
         ...
         <div class="comment_section">
           <a href="<?php echo $posted_by ?>" target="_parent"><img src="<?php echo $user_obj->getProfilePic(); ?>" title="<?php echo $posted_by ?>" style="float:left; margin-right: 6px;" height="33"></a>
           <a href="<?php echo $posted_by ?>" taregt="_parent"> <b><?php echo $user_obj->getFirstAndLastName(); ?></b></a>
       ...
       echo "<centre><br>No Comments to Show!</br></centre>";
     }
